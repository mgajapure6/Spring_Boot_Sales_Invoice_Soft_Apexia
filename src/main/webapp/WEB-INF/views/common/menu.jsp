   ...
   <div class="sidebar-content">
     <div class="nav-container">
       <ul id="main-menu-navigation" data-menu="menu-navigation" class="navigation navigation-main">
         <li class="has-sub nav-item"><a href="javascript:void(0);"><i class="ft-home"></i><span data-i18n="" class="menu-title">Dashboard</span><span class="tag badge badge-pill badge-danger float-right mr-1 mt-1">2</span></a>
           <ul class="menu-content">
             <li class="active"><input type="hidden" class="hiddenJspUrl" value="dashboard/SalesDashboard"><a href="javascript:void(0);" onclick="loadPage('dashboard/SalesDashboard')" class="menu-item">Sales Dashboard</a>
             </li>
             <li><a href="javascript:void(0);" onclick="loadPage(this)" class="menu-item">Purchase Dashboard</a>
             </li>
           </ul>
         </li>
         ...
         <li class="has-sub nav-item"><a href="javascript:void(0);"><i class="ft-aperture"></i><span data-i18n="" class="menu-title">UI Kit</span></a>
           <ul class="menu-content">
             ...
             <li class="has-sub"><a href="javascript:void(0);" class="menu-item">Icons</a>
               <ul class="menu-content">
         ...
         <li class="has-sub nav-item"><a href="javascript:void(0);"><i class="ft-box"></i><span data-i18n="" class="menu-title">Components</span></a>
           <ul class="menu-content">
             <li class="has-sub"><a href="javascript:void(0);" class="menu-item">Bootstrap</a>
               <ul class="menu-content">
             ...
             <li class="has-sub"><a href="javascript:void(0);" class="menu-item">Extra</a>
               <ul class="menu-content">
         ...
         <li class="has-sub nav-item"><a href="javascript:void(0);"><i class="ft-edit"></i><span data-i18n="" class="menu-title">Forms</span></a>
           <ul class="menu-content">
             <li class="has-sub"><a href="javascript:void(0);" class="menu-item">Elements</a>
               <ul class="menu-content">
             ...
             <li class="has-sub"><a href="javascript:void(0);" class="menu-item">Layouts</a>
               <ul class="menu-content">
         ...
         <li class="has-sub nav-item"><a href="javascript:void(0);"><i class="ft-grid"></i><span data-i18n="" class="menu-title">Tables</span></a>
           <ul class="menu-content">
         ...
         <li class="has-sub nav-item"><a href="javascript:void(0);"><i class="ft-layout"></i><span data-i18n="" class="menu-title">Data Tables</span></a>
           <ul class="menu-content">
         ...
         <li class="has-sub nav-item"><a href="javascript:void(0);"><i class="ft-layers"></i><span data-i18n="" class="menu-title">Cards</span></a>
           <ul class="menu-content">
         ...
         <li class="has-sub nav-item"><a href="javascript:void(0);"><i class="ft-layers"></i><span data-i18n="" class="menu-title">Maps</span></a>
           <ul class="menu-content">
             <li><a href="google-map.html" class="menu-item">Google Map</a>
             </li>
           </ul>
         </li>
         <li class="has-sub nav-item"><a href="javascript:void(0);"><i class="ft-bar-chart-2"></i><span data-i18n="" class="menu-title">Charts</span></a>
           <ul class="menu-content">
         ...
         <li class="has-sub nav-item"><a href="javascript:void(0);"><i class="ft-copy"></i><span data-i18n="" class="menu-title">Pages</span></a>
           <ul class="menu-content">
         ...
         <li class=" nav-item"><a href="../../pixinvent_ticksy_default.html"><i class="ft-life-buoy"></i><span data-i18n="" class="menu-title">Support</span></a>
         </li>
       </ul>
     </div>
   </div>
